...
abstract class $IngredientCopyWith<$Res> {
  ...
  @useResult
  $Res call({String name, double singlePrice});
}
...
class _$IngredientImpl implements _Ingredient {
  const _$IngredientImpl({required this.name, required this.singlePrice});
  ...
  @override
  String toString() {
    return 'Ingredient(name: $name, singlePrice: $singlePrice)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, name, singlePrice);
...
abstract class _Ingredient implements Ingredient {
  const factory _Ingredient(
      ...
      required final double singlePrice}) = _$IngredientImpl;
